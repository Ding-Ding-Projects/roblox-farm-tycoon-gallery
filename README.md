...
The current source is `main` at the latest published commit. Native browser verification must confirm the two September 21 free-building cards, newest-first ordering, the New evidence and All captures filters, and the date-unavailable failed ledger at the end. These checks verify gallery delivery only and do not claim runtime completion of the underlying game.
