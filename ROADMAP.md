...
- [x] Verify public delivery of the page, corrected inventory and 149 image URLs and hashes. The full image sweep ran at `c714b85`; `192a44c` changed only the inventory note and its deployed bytes plus newest image were rechecked.
...
- [x] Verify deployment 35908563819 at content 1759b39, unauthenticated page and inventory bytes, and all 148 hosted image hashes. Browser interaction remains unverified.
...
- [x] Verify public deployment 35830445822 at `e0108d5`, visibility, exact page and inventory blobs, and all 135 original image hashes. See [delivery evidence](evidence/gallery-135-live.json). Browser interaction was not repeated.
...
- [x] Verify public deployment 35829887931 at `a8e5e34`, visibility, exact page and inventory blobs, and all 133 original image hashes. See [delivery evidence](evidence/gallery-133-live.json). Browser interaction was not repeated.
...
- [x] Sort all 99 source inventory records by validated capture time with unavailable dates last, preserving every record and image hash; the source order matches all 99 static page cards. See [ordering evidence](evidence/gallery-99-ordering.json).
- [ ] Verify public deployment and exact inventory readback after the source ordering correction.
...
- [x] Verify live delivery of the September 21 free-building captures and their newest-first placement.
...
- [x] Add five reviewed standalone-silo and crop views, preserving all 69 prior identities and original hashes.
